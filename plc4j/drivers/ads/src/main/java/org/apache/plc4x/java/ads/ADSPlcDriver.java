...
public class ADSPlcDriver extends GeneratedDriverBase<AmsTCPPacket> {
    ...
    @Override
    protected ProtocolStackConfigurer<AmsTCPPacket> getStackConfigurer(Configuration configuration, Transport transport) {
        return SingleProtocolStackConfigurer.builder(AmsTCPPacket.class, AmsTCPPacketIO.class, configuration)
